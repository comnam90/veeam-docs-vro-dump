...
product: "vro"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vro/userguide/states_modes_cloud.html"
...
| NEEDS VERIFIED | ![Plan States and Modes](images/plan_notverified.webp) | Plan has never passed a readiness check or has been changed since the last readiness check. |
| NOT VERIFIED | ![Plan States and Modes](images/plan_verificationfailed.webp) | Plan has failed to pass a readiness check or malware scan. |
| VERIFIED | ![Plan States and Modes](images/plan_verified.webp) | Plan has successfully passed a readiness check or malware scan. |
...
| RESTORED | ![Plan States and Modes](images/plan_complete.webp) | Restore process completed successfully. |
| ![Plan States and Modes](images/state_warning.webp) | Restore process completed with one or more warnings. |
| ![Plan States and Modes](images/state_error.webp) | Restore process completed with one or more errors. |
...
| RESTORE | ![Plan States and Modes](images/plan_processing.webp) | Plan is executing. |
...
| --- |
| Note |
| If you perform any infrastructure configuration changes (add, delete or rename VMs) or changes to Veeam ONE Business View groups, Orchestrator will not automatically apply these changes to plans that are currently being executed — such plans are ‘locked’ and cannot be edited. The changes will take effect only if the plans enter the VERIFIED, NEEDS VERIFIED or NOT VERIFIED state. |
...
| ENABLED | ![Plan States and Modes](images/plan_enabled.webp) | Plan is ready to be verified, scanned and executed.  Notes: |
| DISABLED | ![Plan States and Modes](images/plan_disabled.webp) | Plan is ready to be edited and scanned.  Notes:  Scheduled plan execution is not available. Automatic report updates are disabled. |
