...
product: "vro"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vro/userguide/cloud_plan_rto_rpo.html"
...
| --- |
| Note |
| If you choose to perform malware scan [while running the plan](running_cloud.md#ransomware), Orchestrator will scan one disk per mount server at a time. This process may take a while, affecting the plan RTO. |

RTO and RPO performance will be recorded in the [Plan Readiness Check](running_readiness_check.md), [Plan Execution](viewing_plan_execution_history.md) and [Plan Audit](viewing_audit_report.md) reports, and you will be able to track the achieved RTO and RPO objectives for each plan on the [Home Page Dashboard](home_dashboard.md).

[![Creating Cloud Plan](images/creating_cloud_plan_rto.webp)](images/creating_cloud_plan_rto.webp "Creating Cloud Plan")
