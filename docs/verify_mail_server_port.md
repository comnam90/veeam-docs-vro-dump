---
title: "Verify Mail Server Port"
product: "vro"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vro/userguide/verify_mail_server_port.html"
...
| Server | Name of the server to check.  Note: The DNS name or IPv4 address should be used. | [%current\_vm\_ip\_list%](parameter_variables.md) |
